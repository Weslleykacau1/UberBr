  ...
  return (
    <div className="flex flex-col items-center justify-center h-full bg-primary p-4 text-primary-foreground">
      ...
      <div className="w-full max-w-sm space-y-4">
        ...
        <Button onClick={() => setScreen('login')} variant="outline" className="w-full border-2 border-primary-foreground bg-primary text-primary-foreground font-bold py-4 h-auto text-lg hover:bg-primary-foreground/10 transition-transform transform hover:scale-105"><Car className="mr-3" /> Entrar como Motorista</Button>
      </div>
