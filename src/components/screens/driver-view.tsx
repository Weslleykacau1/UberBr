    ...
    <div className="relative h-full w-full bg-secondary text-foreground">
      <div className="absolute inset-0 z-0">
          <Suspense fallback={<div className="bg-muted w-full h-full flex items-center justify-center"><p>Carregando mapa...</p></div>}>
            <DynamicMap mapId={`driver-home-${isOnline ? 'online' : 'offline'}`} center={[-3.74, -38.54]} drivers={[{id: 1, name: 'Antônio', rating: 4.8, car: 'Fiat Cronos', distance: '5 min', position: [-3.742, -38.535]}]} userPos={[-3.74, -38.54]} />
        </Suspense>
