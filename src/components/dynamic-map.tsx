...
const driverIcon = new L.DivIcon({
    html: `<div class="p-1 bg-gray-900 rounded-full border-2 border-lime-400"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#a3e635" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M19 17h2c.6 0 1-.4 1-1v-3c0-2.2-1.8-4-4-4H6c-2.2 0-4 1.8-4 4v3c0 .6.4 1 1 1h2"/><path d="M12 17V9"/><path d="M6 17h12"/><circle cx="6" cy="17" r="2"/><circle cx="18"cy="17" r="2"/></svg></div>`,
    className: '',
    iconSize: [32, 32],
    iconAnchor: [16, 16],
});

const fromIcon = new L.DivIcon({html: '<div class="bg-green-500 text-white font-bold w-6 h-6 flex items-center justify-center rounded-full border-2 border-white">A</div>', className: '', iconSize: [24,24], iconAnchor: [12,12]});
const toIcon = new L.DivIcon({html: '<div class="bg-red-500 text-white font-bold w-6 h-6 flex items-center justify-center rounded-full border-2 border-white">B</div>', className: '', iconSize: [24,24], iconAnchor: [12,12]});
